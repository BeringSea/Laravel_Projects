...
var tid = setInterval(function () {
    ...
    var addCategoryBtn = document.getElementsByClassName('btn')[0]; // dohvatamo prvo dugme iz niza na strani
...
function addCategoryToPost(event) {
    ...
    if (parseCategories().indexOf(selectedCategoryID) != -1) { // f-ja indexOf() vraca -1 po difoltu ako se id ne nalazi u nizu, ovde se proverava da li se id vec nalazi u nizu pa ako se nalazi samo se izadje iz ifa
        return;
    }

...
@section('styles')
    <link rel="stylesheet" href="{{asset('src/css/modal.css')}}" type="text/css">
...
@section('content')
    ...
    {{--modalni dijalog koji se pojavljuje kad se klikne na view--}}
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('src/js/modal.js')}}"></script>
    <script type="text/javascript" src="{{asset('src/js/contact_messages.js')}}"></script>
@endsection